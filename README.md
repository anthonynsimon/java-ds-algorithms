...
- [Priority Queue using min-heap)](/src/main/java/anthonynsimon/datastructures/PriorityQueue.java)
...
- [Build list of lists that each contain the tree nodes per height level](/src/main/java/anthonynsimon/algorithms/trees/BinaryTreeToLists.java)
...
- [Find a the start of a loop in a linked list](/src/main/java/anthonynsimon/algorithms/lists/ListLoopChecker.java)
