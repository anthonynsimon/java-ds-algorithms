...
public class NullifyMatrix {
  ...
  private boolean hasUniformRows(int[][] matrix) {
  ...
  private void scanAndMarkNullable(int[][] matrix, boolean[] nullableRows, boolean[] nullableColumns) {
    for (int i = 0; i < matrix.length; i++) {
  ...
  private void nullifyRows(int[][] matrix, boolean[] nullableRows) {
  ...
  private void nullifyColumns(int[][] matrix, boolean[] nullableColumns) {
