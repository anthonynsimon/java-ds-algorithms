...
public class OneEditChecker {
  ...
  private boolean hasOneDiff(String strA, String strB) {
  ...
  private boolean hasNoDiff(String shorterStr, String largerStr) {      
    int indexShorter = 0;
